...
- [Investment-banking-Financial-analysis-and-Valuation-Coursera](#investment-banking-financial-analysis-and-valuation-coursera)
  * [Module 1](#module-1)
    + [Introduction to Financial Spreads](#introduction-to-financial-spreads)
      - [How do we enable comparability analysis?](#how-do-we-enable-comparability-analysis-)
      - [Spread must be in a Standardised Format](#spread-must-be-in-a-standardised-format)
      - [Getting Financial Data](#getting-financial-data)
    + [Multiples](#multiples)
      - [Valuation Multiples](#valuation-multiples)
      - [Enterprise vs. Equity Value](#enterprise-vs-equity-value)
      - [Equity Value & Equity Value Multiples](#equity-value---equity-value-multiples)
      - [Enterprise Value (EV) Multiples](#enterprise-value--ev--multiples)
    + [Fully Diluted Shares Outstanding](#fully-diluted-shares-outstanding)
      - [Basic vs. Fully Diluted Shars - When to Use?](#basic-vs-fully-diluted-shars---when-to-use-)
      - [What are dilutive securities?](#what-are-dilutive-securities-)
      - [Stock Options / Warrants](#stock-options---warrants)
      - [What is "in the money"](#what-is--in-the-money-)
      - [Restricted Stock Units](#restricted-stock-units)
      - [Convertible Securities (Preferred Stock and Debt)](#convertible-securities--preferred-stock-and-debt-)
      - [Recap - Fully Diluted Shares](#recap---fully-diluted-shares)
    + [Financial Adjustments](#financial-adjustments)
      - [Review of the Spread Template](#review-of-the-spread-template)
      - [Stub periods](#stub-periods)
      - [Calendarisation](#calendarisation)
      - [Financial adjustments](#financial-adjustments)
      - [Financial adjustment examples](#financial-adjustment-examples)
      - [How to Locate Adjustments](#how-to-locate-adjustments)
  * [Module 2](#module-2)
    + [Introduction to Valuation Analysis](#introduction-to-valuation-analysis)
      - [Valuation Observations](#valuation-observations)
      - [Public Companies - Stock Price](#public-companies---stock-price)
      - [Most Common Valuation Approaches](#most-common-valuation-approaches)
      - [Use of FDS and Normalised Earnings](#use-of-fds-and-normalised-earnings)
      - [Use the Implied Multiple to Calculate Valuation](#use-the-implied-multiple-to-calculate-valuation)
    + [Comparable Public Companies Analysis](#comparable-public-companies-analysis)
      - [Five Steps to Perform Public Comparable Analysis](#five-steps-to-perform-public-comparable-analysis)
    + [Spreading Financial Information and Benchmarking](#spreading-financial-information-and-benchmarking)
      - [Financial Spreads Feed the Analysis](#financial-spreads-feed-the-analysis)
    + [Advantages and Disadvantages to Comparable Public Companies Analysis](#advantages-and-disadvantages-to-comparable-public-companies-analysis)
      - [Pros for Comparable Company Analysis](#pros-for-comparable-company-analysis)
      - [Cons for Comparable Company Analysis](#cons-for-comparable-company-analysis)
  * [Module 3](#module-3)
    + [Comparable Precedent Transaction Analysis](#comparable-precedent-transaction-analysis)
      - [Similarities between Public and Transaction Comparables](#similarities-between-public-and-transaction-comparables)
      - [Differences 1 of 3](#differences-1-of-3)
      - [Differences 2 of 3](#differences-2-of-3)
      - [Differences 3 of 3](#differences-3-of-3)
    + [Steps to Performing Comparable Precedent Transaction Analysis](#steps-to-performing-comparable-precedent-transaction-analysis)
      - [Precedent Transactions Analysis Steps](#precedent-transactions-analysis-steps)
    + [Finding Transaction Comparables](#finding-transaction-comparables)
      - [Step 1: Select the Universe of Comparable Acquisitions](#step-1--select-the-universe-of-comparable-acquisitions)
    + [Unique Aspects of Spreading a Transaction Comparable](#unique-aspects-of-spreading-a-transaction-comparable)
      - [Unique Aspects of Spreading a Transaction](#unique-aspects-of-spreading-a-transaction)
      - [Fully Diluted Shares and TEV Calculations](#fully-diluted-shares-and-tev-calculations)
      - [Different Forms of Consideration](#different-forms-of-consideration)
      - [Calculation of Premium Paid](#calculation-of-premium-paid)
      - [Impact of Synergies](#impact-of-synergies)
    + [Advantages and Disadvantages of Comparable Transactions Analysis](#advantages-and-disadvantages-of-comparable-transactions-analysis)
      - [Advantages of Comparable Precedent Transactions Analysis](#advantages-of-comparable-precedent-transactions-analysis)
      - [Disadvantages of Comparable Precedent Transactions Analysis](#disadvantages-of-comparable-precedent-transactions-analysis)
  * [Module 4](#module-4)
    + [Discounted Cash Flows - An Introduction](#discounted-cash-flows---an-introduction)
      - [Overview](#overview)
      - [Free Cash Flow](#free-cash-flow)
      - [DCF Steps](#dcf-steps)
    + [Discounted Cash Flows - Projecting Free Cash Flows](#discounted-cash-flows---projecting-free-cash-flows)
      - [Overview](#overview-1)
      - [Free Cash Flow](#free-cash-flow-1)
      - [Income Statement Drivers](#income-statement-drivers)
      - [Balance Sheet Drivers](#balance-sheet-drivers)
      - [How Changes in Working Capital Impacts Cash Flow](#how-changes-in-working-capital-impacts-cash-flow)
    + [Discounted Cash Flows - WACC](#discounted-cash-flows---wacc)
      - [Overview](#overview-2)
      - [WACC Formula](#wacc-formula)
      - [WACC Steps](#wacc-steps)
      - [Target Capital Structure](#target-capital-structure)
    ...
    + [Discounted Cash Flows - Terminal Value](#discounted-cash-flows---terminal-value)
      - [Overview](#overview-3)
      - [Exit Multiple Method](#exit-multiple-method)
      - [Perpetuity Growth Method](#perpetuity-growth-method)
      - [Discounted Cash Flows - Calculate Present Value and Determine Valuation](#discounted-cash-flows---calculate-present-value-and-determine-valuation)
      - [Overview](#overview-4)
      - [Determining Enterprise Value](#determining-enterprise-value)
      - [Determining Equity Value](#determining-equity-value)
      - [Sensitivity Analysis](#sensitivity-analysis)
      - [DCF Pros and Cons](#dcf-pros-and-cons)
